...
// 날씨 api - 서울
var apiURI = "http://api.openweathermap.org/data/2.5/weather?q="+'seoul'+"&appid="+"adca84129bdf7f7358aa0a533d29a37b";
$.ajax({
    url: apiURI,
    dataType: "json",
    type: "GET",
...
// 날씨 api - 경기도
var apiURI = "http://api.openweathermap.org/data/2.5/weather?q="+'Gyeonggi-do'+"&appid="+"adca84129bdf7f7358aa0a533d29a37b";
$.ajax({
    url: apiURI,
    dataType: "json",
    type: "GET",
